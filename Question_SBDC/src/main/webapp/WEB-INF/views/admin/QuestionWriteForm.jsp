			...
			<div class="col-10">
				...
				<form name="frm" method="post">
					...
					<table class="table table-striped table-sm">
						<tr>
							<td>문항 단계</td>
							<td><input type="text" size="10" name="ques_real_depth"></td>
							<td>문항 세부단계</td>
							<td><input type="text" size="10" name="ques_num"></td>
						</tr>
						<tr>
							<td>문항 내용</td>
							<td colspan="2"><textarea cols="50" rows="10"
									name="ques_text"></textarea></td>
						</tr>
					</table>
					<hr>
					<button type="submit" class="btn btn-primary px-3"
						onclick="Question_WriteChk();">저장</button>
