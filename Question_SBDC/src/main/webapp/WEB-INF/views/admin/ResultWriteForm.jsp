		...
		<div class="row">
			...
			<div class="col-10">
				...
				<form name="frm" method="post">
					<button type="button"
						onclick="location.href='AdminMain?ListType=Result'"
						class="btn btn-primary px-3">목록으로</button>
					<br> <br>
					<h4>
						<b>최종 사업 상세</b>
					</h4>
					...
					<table class="table table-striped table-sm">
						...
						<tr>
							<td><input type="text" size="80" name="res_biz_text"></td>
							<td><input type="text" size="20" name="res_link"></td>
						</tr>
					</table>
					<br>
					<button type="submit" class="btn btn-primary px-3"
						onclick="Result_WriteChk();">저장</button>
					<button type="reset" class="btn btn-outline-secondary"
						onclick="history.back()">뒤로가기</button>
					<!-- 230524 onclick 기능 추가, (취소) 에서 (뒤로가기)로 문구수정 -->
				</form>
				<div class="col-1"></div>
			</div>
		</div>
